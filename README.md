...
Um único script, `TCC_Algodao_AMCs_Finalizado.py`, executa as cinco etapas
...
6. Distribuição por UF das AMCs especializadas — Tabela 4

Basta ajustar `PASTA_DADOS` no início do script e rodar do início ao fim.

## Estrutura do repositório

- `TCC_Algodao_AMCs_Finalizado.py` — script único com as cinco etapas
...
A Etapa 6 também baixa automaticamente, via URL, a base pública de códigos e
nomes de município (Kelvins, 2024) — não precisa baixar nada manualmente.
